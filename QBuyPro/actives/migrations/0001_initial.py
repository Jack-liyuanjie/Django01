    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activies', to='actives.activemodel', verbose_name='活动名')),
                ('goods', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activies', to='goods.goodsmodel', verbose_name='商品名')),
            ],
            options={
                'verbose_name': '活动详情',
